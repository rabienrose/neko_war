...
func _ready():
	...
	if Global.server_mode:
		...
		if Global.level_mode:
			...
			init_meat_num[0]=int(Global.global_data["level_init_gold"]/Global.global_data["level_init_discount"][info_t["difficulty"]]) 
			init_meat_num[1]=int(Global.global_data["level_init_gold"]*Global.global_data["level_init_discount"][info_t["difficulty"]])
